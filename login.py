...
def run_login():
    st.set_page_config(page_title="My Expense Manage",page_icon=":bar_chart:",layout="wide")
    st.title("My Expense Manager💸🤑")
    st.markdown("<p><TT>Designed and Developed by <a style='text-decoration:none;color:red' target='_blank' href='https://github.com/Ritesh778'>J.Ritesh</a> & <a style='text-decoration:none;color:red' target='_blank' href='https://github.com/sasivatsal7122'>B.Sasi Vatsal</a></TT></p>", unsafe_allow_html=True)
